...
samples = {
  "data": {
         ...
         "isSig"    : False,
         "files"    : hdf5inpath("/eos/user/c/cericeci/SUEP/28_05_2022_ee//data/"),#+ hdf5inpath("/eos/user/c/cericeci/SUEP/25_07_2022_ee_SRonly/data_RunB/")+hdf5inpath("/eos/user/c/cericeci/SUEP/25_07_2022_ee_SRonly/data_RunC/")+hdf5inpath("/eos/user/c/cericeci/SUEP/25_07_2022_ee_SRonly/data_RunD/"),
         "markerstyle": 20,
         "markersize" : 1,
  },
  "DY": {
         ...
         "files"      : hdf5inpath("/eos/user/c/cericeci/SUEP/28_05_2022_ee/DY/"),
  },      
  "ttto2l": {
         ...
         "fillcolor": 2, # Red
         "isSig"    : False,
         "files"    :  hdf5inpath("/eos/user/c/cericeci/SUEP/28_05_2022_ee/TTTo2L2Nu/"),
         "extraWeights": lambda x: 1,
  },
  "ttto1l": {
         ...
         "fillcolor": 5, # Yellow
         "isSig"    : False,
         "files"    : hdf5inpath("/eos/user/c/cericeci/SUEP/28_05_2022_ee/TTTo2J1L1Nu/"),
         "extraWeights": lambda x: 1,
  },
  "Wjets": {
         ...
         "fillcolor": 6, # Purple
         "isSig"    : False,
         "files"    : hdf5inpath("/eos/user/c/cericeci/SUEP/28_05_2022_ee/WJets/"), 
         "extraWeights": lambda x: 1,
  },
}
