...
class SUEP_cluster(processor.ProcessorABC):
    ...
    def selectByTrigger(self, events, extraColls = []):
        ...
        cutAnyHLT = (events.HLT.Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8) | (events.HLT.IsoMu24)
    ...
    ###lepton selection criteria--4momenta collection for plotting
        ...
        cutElectrons = (events.Electron.pt >= 15)
    ...
    def process(self, events):
        ...
        if not(self.isMC):
          ...
          cutGolden = ( (events.run == 356043) & ( ((events.luminosityBlock >= 1) & (events.luminosityBlock <= 50)) | ((events.luminosityBlock >= 58) & (events.luminosityBlock <= 65)) )) | ( (events.run == 356075) & ( ((events.luminosityBlock >= 1) & (events.luminosityBlock <= 125)) )) | ( (events.run == 355942) & ( ((events.luminosityBlock >= 24) & (events.luminosityBlock <= 189)) | ((events.luminosityBlock >= 193) & (events.luminosityBlock <= 213)) )) | ( (events.run == 355988) & ( ((events.luminosityBlock >= 43) & (events.luminosityBlock <= 54)) | ((events.luminosityBlock >= 60) & (events.luminosityBlock <= 80)) )) | ( (events.run == 356071) & ( ((events.luminosityBlock >= 37) & (events.luminosityBlock <= 38)) | ((events.luminosityBlock >= 54) & (events.luminosityBlock <= 72)) | ((events.luminosityBlock >= 83) & (events.luminosityBlock <= 153)) | ((events.luminosityBlock >= 177) & (events.luminosityBlock <= 191)) )) | ( (events.run == 355933) & ( ((events.luminosityBlock >= 79) & (events.luminosityBlock <= 448)) )) | ( (events.run == 355921) & ( ((events.luminosityBlock >= 38) & (events.luminosityBlock <= 193)) | ((events.luminosityBlock >= 195) & (events.luminosityBlock <= 210)) | ((events.luminosityBlock >= 212) & (events.luminosityBlock <= 338)) | ((events.luminosityBlock >= 340) & (events.luminosityBlock <= 406)) | ((events.luminosityBlock >= 408) & (events.luminosityBlock <= 442)) )) | ( (events.run == 355872) & ( ((events.luminosityBlock >= 1) & (events.luminosityBlock <= 377)) )) | ( (events.run == 355913) & ( ((events.luminosityBlock >= 1) & (events.luminosityBlock <= 106)) )) | ( (events.run == 355912) & ( ((events.luminosityBlock >= 43) & (events.luminosityBlock <= 72)) | ((events.luminosityBlock >= 77) & (events.luminosityBlock <= 191)) | ((events.luminosityBlock >= 200) & (events.luminosityBlock <= 200)) )) | ( (events.run == 355892) & ( ((events.luminosityBlock >= 14) & (events.luminosityBlock <= 46)) )) | ( (events.run == 356074) & ( ((events.luminosityBlock >= 1) & (events.luminosityBlock <= 26)) )) | ( (events.run == 356077) & ( ((events.luminosityBlock >= 1) & (events.luminosityBlock <= 290)) | ((events.luminosityBlock >= 292) & (events.luminosityBlock <= 472)) )) | ( (events.run == 356076) & ( ((events.luminosityBlock >= 1) & (events.luminosityBlock <= 152)) )) # RunC, as of August 03
    ...
    def doAllPlots(self, channel, debug=True):
        ...
        for ev in self.events:
          if ev.MET.pt >= 400 or ev.PuppiMET.pt >= 400:
            print(print(ev.event, ev.luminosityBlock, ev.run, ev.MET.pt, ev.PuppiMET.pt))
